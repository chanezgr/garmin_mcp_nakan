...
def register_tools(app):
    ...
    @app.tool()
    async def get_weigh_ins(start_date: str, end_date: str):
    ...
    @app.tool()
    async def get_daily_weigh_ins(date: str):
    ...
    @app.tool()
    async def delete_weigh_ins(date: str, delete_all: bool = True):
    ...
    @app.tool()
    async def add_weigh_in(weight: float, unit_key: str = "kg"):
