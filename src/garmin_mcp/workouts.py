...
def register_tools(app):
    ...
    @app.tool()
    async def upload_workout(workout_data: dict):
    ...
    @app.tool()
    async def upload_activity(file_path: str):
    ...
    @app.tool()
    async def get_scheduled_workouts(start_date: str, end_date: str):
    ...
    @app.tool()
    async def get_training_plan_workouts(calendar_date: str):
